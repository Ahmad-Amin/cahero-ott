        ...
        <div className="mr-10">
          ...
          <div style={{ position: "relative", zIndex: 2 }}>
            ...
            <p className="text-white font-light mx-8 opacity-65 mt-3">
              ...
              and home care needs. Using WELPCO I ensure that my loved ones and
              home are always in good hands. The platform's vetted and
            ...
            <h1 className="text-xl font-semibold text-white">Verified Info</h1>
            </div>

            <div
              className="text-white mt-3 mx-4 md:mx-8 text-base font-normal flex justify-between w-auto"
            >
