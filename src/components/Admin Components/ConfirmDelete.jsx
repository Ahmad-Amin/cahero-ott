...
const ConfirmDelete = ({ isOpen, onClose, onConfirm }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div ref={modalRef} className="bg-[#101011] border border-white rounded-2xl p-6 w-1/3 h-1/3 flex items-center justify-center">
        <div>
        <div className="text-center mb-10">
          <h2 className="text-white text-2xl font-semibold">
            Do you really want to delete this webinar?
          </h2>
        </div>
