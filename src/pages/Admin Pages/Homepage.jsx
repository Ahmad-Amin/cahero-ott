      ...
      <div className="px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 items-center">
          <div className="bg-[#ffe2e5] rounded-3xl shadow-md aspect-square">
            ...
            <div className="w-auto justify-start items-center mx-7 my-5">
              <div className="space-y-3">
                <h1 className="text-[#151d48] font-bold text-4xl">$ 1K</h1>
          ...
          <div className="bg-[#fff4de] rounded-3xl shadow-md aspect-square">
            ...
            <div className="w-auto justify-start items-center mx-7 my-5">
              <div className="space-y-3">
                <h1 className="text-[#151d48] font-bold text-4xl">120</h1>
                <h1 className="text-[#425166] font-bold text-2xl">
                  Active Users
                </h1>
                <h1 className="text-[#4079ed] font-bold text-xl">
          ...
          <div className="bg-[#dcfce7] rounded-3xl shadow-md aspect-square">
            ...
            <div className="w-auto justify-start items-center mx-7 my-5">
              <div className="space-y-3">
                <h1 className="text-[#151d48] font-bold text-4xl">357</h1>
                <h1 className="text-[#425166] font-bold text-2xl">
                  Total Subscribers
                </h1>
                <h1 className="text-[#4079ed] font-bold text-xl">
          ...
          <div className="bg-[#f3e8ff] rounded-3xl shadow-md aspect-square">
            ...
            <div className="w-auto justify-start items-center mx-7 my-5">
              <div className="space-y-3">
                <h1 className="text-[#151d48] font-bold text-4xl">8</h1>
        ...
        <div className="bg-black rounded-2xl p-10 mt-10 flex flex-row gap-8">
          ...
          <div className="w-auto h-auto flex justify-end">
            <Link to="/dashboard/webinars/create-webinar">
              <button className="w-52 h-16 bg-[#6a55ea] text-white rounded-xl text-lg font-semibold hover:bg-[#3b2f83] ease-in-out transition duration-300">
                Create Webinar
              </button>
            </Link>
          </div>
