  ...
  const posts = [
    {
      ...
      image: `${process.env.PUBLIC_URL}/images/post.png`,
      likes: 12,
      comments: 25,
      shares: 187,
    },
    ...
    },
    {
      ...
      name: "John Doe",
      profession: "Web Developer",
      content: "Habitant morbi tristique senectus et netus et.",
      hashtags: "#amazing #great #lifetime #uiux #machinelearning",
      image: `${process.env.PUBLIC_URL}/images/post.png`,
      likes: 12,
      comments: 25,
                ...
                <div key={post.id}>
                  ...
                  <div className="border-b-2 border-[#232323]">
                    ...
                    <img
                      src={post.image}
                      alt=""
                      className="w-full px-8 my-8 rounded-lg"
                    />
                    <div className="flex flex-row my-8">
                      ...
                      <div className="flex flex-row">
                        ...
                        <p className="text-white">{post.comments} Comments</p>
                      </div>
                      <div className="flex flex-row">
